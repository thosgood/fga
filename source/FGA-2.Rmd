...
For simplicity, we work over a \emph{field} $k$, i.e. we work in \emph{equal characteristic}, even though  [Theorem 8](#FGA-2-theorem-8) allows us to also discuss the more general case, without any fundamental changes, so it seems.
