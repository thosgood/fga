...
The substance of [§1](#fga-2-section-1) to [§5](#fga-2-section-5) is contained in the published part of [@GD1960, III]; that of [§6](#fga-2-section-6) and [§7](#fga-2-section-7) is contained in [@Gro1960b, III].
...
\oldpage{182-09}
This also implies that, for every $y\in Y$, if we filter $\scr{F}$ along the fibre $f^{-1}(y)$ by the $\frak{m}_y^n\scr{F}$ (where $\frak{m}_y$ is the maximal ideal of $\scr{O}_y$), then the associated graded algebra is isomorphic to $(\scr{F}/\frak{m}_y\scr{F})\otimes_{k(y)}\gr(\scr{O}_y)$;
