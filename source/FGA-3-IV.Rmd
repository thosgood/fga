...
Unfortunately, they have not as of yet allowed us to solve the existence problems posed in [@Gro1959, II].
...
In the next article, the theory of passing to the quotient in schemes, developed in [@Gro1959, III], combined with the theory of Hilbert schemes, will allow us, for example, to construct Picard schemes (defined in [@Gro1959, II, §3]) under rather general conditions.
...
When the symmetric $n$-th power of $X$ over $S$ exists (for example, if the orbits of the symmetric group $\sigma_n$ acting on $(X/S)^n$ are contained inside open affines), we can take $Y$ to be this symmetric power $\Symm_S^n(X)$, and we obtain a canonical element
$$
...
(It is, however, plausible that such limitations do not present themselves in analytic geometry, just as they do not present themselves in formal geometry (cf. [@Gro1959, II])).
