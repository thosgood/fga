...
It was not defined when $x$ was a simple point of the variety of parameters $T$ of a "complete continuous family" of divisors, i.e. from our point of view, an irreducible component of the scheme $D$, endowed with the induced *reduced* structure.
