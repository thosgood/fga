...
for example, the $\scr{F}/\scr{F}_i$, where the $\scr{F}_i$ are the primary subsheaves of $\scr{F}$ tfor the components of the support of $\scr{F}$, and minimal with respect to this property;
or the $\cal{O}_{X_K}/\frak{p}$, where $\frak{p}$ is a prime sheaf of ideals associated to $\src{F}$, or the $\cal{O}_{X_K}/\frak{q}$, where the $\src{q}$ is a primary sheaf of ideals associated to a component of the support of $\scr{F}$ (the reference field being algebraically closed).
