...
\providecommand{\shTor}{\underset{\widetilde{\phantom{\Tor}}}{\Tor}}
\providecommand{\Ext}{\operatorname{Ext}}
\providecommand{\shExt}{\underset{\widetilde{\phantom{\Ext}}}{\Ext}}
\providecommand{\Hom}{\operatorname{Hom}}
\providecommand{\shHom}{\underset{\widetilde{\phantom{\Hom}}}{\Hom}}
\providecommand{\supp}{\operatorname{supp}}
\providecommand{\red}{{\mathrm{red}}}
\providecommand{\OO}{\scr{O}}
\providecommand{\PP}{\mathbb{P}}
\providecommand{\Quot}{\operatorname{Quot}}
\providecommand{\shQuot}{\underset{\widetilde{\phantom{\Quot}}}{\Quot}}
\providecommand{\repQuot}{\underline{\Quot}}
\providecommand{\Grass}{\operatorname{Quot}}
\providecommand{\shGrass}{\underset{\widetilde{\phantom{\Grass}}}{\Grass}}
...
Under these conditions, the contravariant functor $\shQuot_{\FXS}$ on the category of locally Noetherian $S$-preschemes is *representable* by an $S$-prescheme $\repQuot}_{\FXS}$, given by the sum of a sequence of projective $S$-schemes (and a fortiori $\repQuot_{\FXS}$ is locally of finite type over $S$).
:::
...
To prove that it is projective over $S$, it thus remains to prove that it is _proper_ over $S$, and for this it suffices to invoke the valuative criteria of properness in the form given in [@5, II, 7.3.8].
...
::: {.proof}
Indeed, if $\scr{G}_s=\scr{F}_s/\scr{H}_s$, it suffices to consider the largest subsheaf $\scr{H}$ of $\scr{F}$ that induces $\scr{H}_s$ ([@5, I, 9.4.2]) and to take $\scr{G}=\scr{F}/\src{H}$.
