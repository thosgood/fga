...
This functor has no chance of being "representable" ([FGA 3.II, A](FGA-3-II.html#fga-3-ii-section-A.1)) since, as a consequence of the existence of *non-trivial automorphisms* of invertible modules that we propose to classify, this functor is not of a *"local nature"* ([@Gro1960a, IV, 5.4]).
...
(where $f\colon X\to S$ is the structure morphism) (cf. [FGA 3.II, C.3](FGA-3-II.html#fga-3-ii-section-C.3)).
...
$$
If $P$ is representable, it follows from the theory of descent ([FGA 3.I, B, Theorem 2](FGA-3-I.html#fga-3-i-section-B.1-theorem-2)) that the diagram [(1.5)](#fga-3-v-equation-1.5) is exact for all $u\in(\scr{M})$.
...
\oldpage{232-03}(N.B. The set $\overline{\HH}^0$ thus defined is larger than the set $\HH^0(T'/T,P)$ introduced in [FGA 3.I, A.4.a](FGA-3-I.html#fga-3-i-section-A.4.a)).
...
$$
is an isomorphism.
The second statement was proven by the theory of descent in [FGA 3.I, B.4](FGA-3-I.html#fga-3-i-section-B.4).
:::
...
We are thus under the hypothesis of [FGA 3.III, Theorem 6.1](FGA-3-III.html#fga-3-iii-theorem-6.1), which implies the desired result.
...
Then $\repPic_{X/S}$ exists and (with the notation introduced in [FGA 3.II, C.2](FGA-3-II.html#fga-3-ii-section-C.2)) we have a canonical isomorphism
$$
  \repPic_{X/S}
...
Applying a descent procedure gives a relative existence theorem, whose scope depends on the solution to questions about non-flat descent that were raised in [FGA 3.I, A.3.c](FGA-3-I.html#fga-3-i-section-A.3.c), and of which we content ourselves here to explain only a particular case:
