...
In *loc. cit.*, we take $\cal{S}$ to be the set of faithfully flat quasi-compact morphisms of preschemes (which are indeed effective epimorphisms, by [@Gro1959, I, B]).
\oldpage{232-13}
...
We are thus under the hypothesis of [@Gro1959, III, 6.1], which implies the desired result.
...
Then $\repPic_{X/S}$ exists and (with the notation introduced in [@Gro1959, II, C.2]) we have a canonical isomorphism
$$
  \repPic_{X/S}
...
Applying a descent procedure gives a relative existence theorem, whose scope depends on the solution to questions about non-flat descent that were raised in [@Gro1959, I, A.c], and of which we content ourselves here to explain only a particular case:
