...
$$
(generalising [A, Proposition 1](#FGA-3-II-section-A.1-proposition-1)).
...
\oldpage{195-06}
We say that $\xi$ (or the pair $(X,\xi)$) is _minimal_ if, for all $X'\in\cal{C}$ and all $\xi'\in F(X')$, and for every strict monomorphism (cf. [@3-II-3, A, §2]) $u\colon X'\to X$ such that $\xi=F(u)(\xi')$, $u$ is an isomorphism.
...
In all these examples, the corollary to [Proposition 3.1](#FGA-3-II-section-A.3-proposition-3.1) applies, and it is indeed by the associated functor that the $\pi_1$ should be defined [@3-II-2].
