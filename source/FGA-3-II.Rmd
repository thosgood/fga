...
In any case, it is the preliminary analysis of [Proposition 5.1](#FGA-3-II-section-C.5-proposition-5.1) that allows us to extend the methods described in [@3-II-2] for the study of the fundamental group to the "tamely ramified" case, and to resolve, by a transcendental way, the "problem of three points".
