...
\oldpage{195-06}
We say that $\xi$ (or the pair $(X,\xi)$) is _minimal_ if, for all $X'\in\cal{C}$ and all $\xi'\in F(X')$, and for every strict monomorphism (cf. [FGA 3.I, A, §2](FGA-3-I.html#fga-3-i-section-A.2)) $u\colon X'\to X$ such that $\xi=F(u)(\xi')$, $u$ is an isomorphism.
