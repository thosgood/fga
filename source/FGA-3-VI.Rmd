...
But the hypothesis that $G_{\overline{k}}$ contains no additive component easily implies that there exists an integer $m$ such that $(G_{\overline{k}}^0)_\red$ is the "scheme-theoretic" image of the $m$-th power homomorphism in $G_{\overline{k}}$.
