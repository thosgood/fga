...
::: {.itenv #fga3.iv-theorem-2.1 title="Theorem 2.1" latex="{Theorem 2.1}"}
  ...
  \todo{the following list should be a, b}
    ...
    b. The Hilbert polynomials $P_\sh{F}$ of the sheaves $\sh{F}$ whose class is in $E$ are elements of a single \em{finite} set of polynomials.
:::
...
- (b<sub>s</sub>) The Poincaré polynomials $P_\sh{F}$ of the sheaves $\sh{F}$ whose class is in $E$ have coefficients \em{in degrees $\leqslant (s-1)$} that are bounded.
