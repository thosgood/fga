...
To prove that it is projective over $S$, it thus remains to prove that it is _proper_ over $S$, and for this it suffices to invoke the valuative criterion of properness in the form given in [[GD1960](GD1960), II, 7.3.8].
