...
::: {.itenv #fga3.iv-2-theorem-2.1 title="Theorem 2.1" latex="{Theorem 2.1}"}
...
::: {.itenv #fga3.iv-2-theorem-2.2 title="Theorem 2.2" latex="{Theorem 2.2}"}
  ...
  \todo{the following list should be b_s}

    1. The Poincaré polynomials $P_\sh{F}$ of the sheaves $\sh{F}$ whose class is in $E$ have coefficients \em{in degrees $\leqslant (s-1)$} that are bounded.
...
::: {.itenv #fga3.iv-2-corollary-2.3 title="Corollary 2.3" latex="{Corollary 2.3}"}
...
::: {.itenv #fga3.iv-2-lemma-2.4 title="Lemma 2.4 (Chow)" latex="{Lemma 2.4 (Chow)}"}
...
::: {.itenv #fga3.iv-2-lemma-2.5 title="Lemma 2.5" latex="{Lemma 2.5}"}
...
::: {.proof}
    (Proof of \ref{fga3.iv-2-theorem-2.2})
    ...
    By \ref{fga3.iv-2-lemma-2.6}, the $\sh{F}_{(r)}$ form a bounded family, and so too, by part (i) of [(1.2)], do the kernels of the homomorphisms $\sh{L}_K\to\sh{F}_{(r)}$;
