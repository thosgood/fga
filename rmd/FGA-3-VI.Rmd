...
::: {.rmenv #fga3.vi-1-remark title="Remark" latex="{Remark}"}
...
::: {.itenv #fga3.vi-1-theorem-1.1 title="Theorem 1.1" latex="{Theorem 1.1}"}
...
::: {.itenv #fga3.vi-1-lemma-1.2 title="Lemma 1.2" latex="{Lemma 1.2}"}
...
The second claim in (i) of \ref{fga3.vi-theorem-1.1} is contained in the following lemma (which we apply to an quasi-compact open neighbourhood of $G^0$ in $G$):

::: {.itenv #fga3.vi-1-lemma-1.3 title="Lemma 1.3" latex="{Lemma 1.3}"}
...
::: {.itenv #fga3.vi-1-lemma-1.4 title="Lemma 1.4" latex="{Lemma 1.4}"}
...
::: {.itenv #fga3.vi-1-corollary-1.5 title="Corollary 1.5" latex="{Corollary 1.5}"}
...
::: {.rmenv #fga3.vi-1-remark-1.6 title="Remark 1.6" latex="{Remark 1.6}"}
...
::: {.itenv #fga3.vi-1-corollary-1.7 title="Corollary 1.7" latex="{Corollary 1.7}"}
  Suppose that $G\to S$ is universally open at the points of $G^0$ (cf. \ref{fga3.vi-corollary-1.5}) and that the fibres $G_s$ are separable, thus simple over $k(s)$ (this latter condition being automatically satisfied in residual characteristic zero, by a result of Cartier).
...
::: {.itenv #fga3.vi-1-corollary-1.8 title="Corollary 1.8" latex="{Corollary 1.8}"}
...
::: {.rmenv #fga3.vi-1-remarks-1.9 title="Remarks 1.9" latex="{Remarks 1.9}"}
...
::: {.itenv #fga3.vi-1-corollary-1.10 title="Corollary 1.10" latex="{Corollary 1.10}"}
...
::: {.itenv #fga3.vi-1-proposition-1.11 title="Proposition 1.11" latex="{Proposition 1.11}"}
...
::: {.itenv #fga3.vi-1-corollary-1.12 title="Corollary 1.12" latex="{Corollary 1.12}"}
  \oldpage{236-11}
