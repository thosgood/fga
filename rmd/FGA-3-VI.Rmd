...
\p{
  ...
  ::: {.itenv #fga3.vi-4-theorem-4.1 title="Theorem 4.1" latex="{Theorem 4.1}"}
  \p{
  ...
  ::: {.itenv #fga3.vi-4-corollary-4.2 title="Corollary 4.2" latex="{Corollary 4.2}"}
  \p{
  ...
  ::: {.rmenv #fga3.vi-4-remark-comp title="Remark" latex="{Remark}"}
  \p{
    \comp
    \oldpage{C-07}
