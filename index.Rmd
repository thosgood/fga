...
Many of the results appearing in these articles have been discussed in detail in the _Séminaire de Géométrie Algébrique du Bois Marie_, as well as in the two subsequent seminars at Harvard, in 1961--62 (the first by myself, and the second by Mumford--Tate), the notes for which are currently in preparation by Lichtenbaum.^[*[Trans.]* These notes are referenced again multiple times throughout these talks, but they do not actually exist: they were never finished, and no draft of them was ever published.]
